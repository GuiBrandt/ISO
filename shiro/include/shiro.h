...
#define shiro_def_native(runtime, name, n_args) {\
	__field_value v;\
	v.func = shiro_new_native(n_args, (shiro_c_function)&__native_fn_name(name));\
	shiro_set_global(runtime, ID(#name), s_fFunction, v);\
}
